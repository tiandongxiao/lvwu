    ...
    <head>
        ...
        <style>
          *{
          ...
          html{
          	background:url('images/meihua.jpg') no-repeat center center;
          	min-height:100%;
